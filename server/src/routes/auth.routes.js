...
const { login, me, changePassword, listAdmins, createAdmin, deleteAdmin, resetAdminPassword, updateAdminRole, updateAdminModules, refreshToken, logout, getDepartments } = require('../controllers/auth.controller');
